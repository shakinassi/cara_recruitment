...
<div class="content"> 
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
            <a href="javascript:;" data-toggle="modal" data-target="#button-modal-preview" class="button text-white bg-theme-1 shadow-md mr-2">Add New category</a>
                ...
                <div class="modal__content relative"> <a data-dismiss="modal" href="javascript:;" class="absolute right-0 top-0 mt-3 mr-3"> <i data-feather="x" class="w-8 h-8 text-gray-500"></i> </a>
                    ...
                    <div class="intro-y box p-5">
                        ...
                        <div class="mt-3">
                            ...
                            <input type="text" class="input w-full border mt-2 form-control" name="category" placeholder="Company Category">
                        </div>
          ...
          <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                ...
                <tbody><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jobcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="intro-x">
                        <td class="w-40">
                            <div class="font-medium whitespace-no-wrap"><?php echo e($jobcategory->company); ?></div> 
                            
                        </td>
                        <td class="w-80">
                            <div class="font-medium whitespace-no-wrap"><?php echo e($jobcategory->category); ?></div> 
                            ...
                            <div class="flex justify-center items-center">
                                ...
                                <div class="modal" id="header-footer-modal-preview" style="z-index:50;">
                                    <div class="modal__content relative" style="margin-top: -5rem;">
                                        ...
                                        <form action="<?php echo e(route('category.update', $jobcategory->id)); ?>" method="post">
                                            <?php echo csrf_field(); ?>
                                                ...
                                                <div>
                                                    <div class="mt-3">
                                                        ...
                                                        <div class="mt-3">
                                                            ...
                                                            class="input w-full border col-span-4 form-control tail-select" value="<?php echo e($jobcategory->company); ?>">
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <div class="mt-3">
                                                            <input type="text" placeholder="Company Category" name="category"
                                                            class="input w-full border col-span-4 form-control tail-select" value="<?php echo e($jobcategory->category); ?>">
    ...
    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jobcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="modal" id="delete-modal-preview" style="z-index:50;">
        <div class="modal__content" style="margin-left: 8rem !important">
            <div class="p-5 text-center"> <i data-feather="x-circle" class="w-16 h-16 text-theme-6 mx-auto mt-3"></i>
                <form action="<?php echo e(route('category.destroy', $jobcategory->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cara_recruitment\resources\views/category/categorylist.blade.php ENDPATH**/ ?>