        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
          ...
          <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                ...
                <tbody>@foreach ($categories as $jobcategory)
                    <tr class="intro-x">
                        <td class="w-40">
                            <div class="font-medium whitespace-no-wrap">{{ $jobcategory->company }}</div> 
                            
                        </td>
                        <td class="w-80">
                            <div class="font-medium whitespace-no-wrap">{{ $jobcategory->category}}</div> 
                            ...
                            <div class="flex justify-center items-center">
                                ...
                                <div class="modal" id="header-footer-modal-preview" style="z-index:50;">
                                    <div class="modal__content relative" style="margin-top: -5rem;">
                                        ...
                                        <form action="{{ route('category.update', $jobcategory->id) }}" method="post">
                                            @csrf
                                            @method('PUT')
                                                ...
                                                <div>
                                                    <div class="mt-3">
                                                        ...
                                                        <div class="mt-3">
                                                            ...
                                                            class="input w-full border col-span-4 form-control tail-select" value="{{ $jobcategory->company}}">
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <div class="mt-3">
                                                            ...
                                                            class="input w-full border col-span-4 form-control tail-select" value="{{ $jobcategory->category}}">
    ...
    <div class="modal" id="delete-modal-preview" style="z-index:50;">
        <div class="modal__content" style="margin-left: 8rem !important">
            <div class="p-5 text-center"> <i data-feather="x-circle" class="w-16 h-16 text-theme-6 mx-auto mt-3"></i>
                <form action="{{ route('category.destroy', $jobcategory->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
