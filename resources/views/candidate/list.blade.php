                ...
                <tr class="intro-x">
                    ...
                    <td class="table-report__action w-56">
                        <div class="flex justify-center items-center">
                            ...
                            {{-- <a href="{{  route('download', ['file' => $candidate->file]) }}" data-toggle="modal" data-target="#header-footer-modal-preview" class="flex items-center mr-3"> <i data-feather="file-plus" class="w-4 h-4 mr-1" ></i> Download </a> --}}
                            ...
                            <a class="flex items-center mr-3" href="{{route('application2',['id'=>$candidate->id])}}"> <i data-feather="user-x" class="w-4 h-4 mr-1"></i> Reject </a>
