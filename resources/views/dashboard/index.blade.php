...
<div class="content">
    ...
    {{-- <h2 class="intro-y text-lg font-medium mt-10">
        ...
        <div class="grid grid-cols-12 mt-8 ">
            ...
            <a href="{{ url('CaraComMy') }}" class="col-span-3">
            ...
            <a href="{{ url('NSTCara') }}" class="col-span-3">
                <div class="cardcardcard grid grid-cols-12">
                    <div class="col-span-8">
                        <div class="logo mt-1">
            ...
            <a href="{{ url('CaraSkadimo') }}" class="col-span-3">
                <div class="cardcardcard grid grid-cols-12">
                    <div class="col-span-8">
                        <div class="logo mt-1">
            ...
            <a href="{{ url('CaraSolution') }}" class="col-span-3">
                <div class="cardcardcard grid grid-cols-12">
                    <div class="col-span-8">
                        <div class="logo mt-1">
